function binned_value_smoothed = tuning_curve_by_value_not_rate(spikes_behave_vec,behave_vec,behave_bin_edges,spikes_value_vec,minimum_time_spent,behav_samples_per_sec,method)
...
[value_in_bins,bins_with_data] = groupsummary(spikes_value_vec,grouping_var,method);
