...
if correct_manually
    ...
    if q1
        ...
        co_ind_to_add=distance_change_sign(indx(val<manual_min_dis_from_CO)); %add CO only if it found closest point of changed sign
        behavioral_modes.CO_point=sort([behavioral_modes.CO_point co_ind_to_add']);
