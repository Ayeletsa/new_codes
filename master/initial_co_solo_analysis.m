...
for ii_cell = 3:length(data_dir_info)
    ...
    cell_co_solo_initial_analysis.solo = spike_struct_solo_data (bsp_data,cell_struct,behavioral_modes,tag_i,solo_param_file_name);
    cell_co_solo_initial_analysis.co = spike_struct_co_data (bsp_data,cell_struct,behavioral_modes,tag_i, cell_co_solo_initial_analysis.solo,co_param_file_name);
