...
%                 
                ...
                if inter_field_data(field_i).time_signif_field.signif_based_on_extreme_bins==1 
                    rise_and_width_data=get_per_field_tuning_width_and_rise_time(inter_field_data(field_i).time_signif_field,min_dis_pos_neg);
...
title_str='tuning of all valid inter fields';
...
title_str='tuning of signif inter fields';
plot2dmats(pos_ax_mat,pos_ax_tuning, data, dis_per_field_bin_vec_of_center,title_str,sort_by_max,ylimits)
...
title_str='tuning of pos signif inter fields';
plot2dmats(pos_ax_mat,pos_ax_tuning, data, dis_per_field_bin_vec_of_center,title_str,sort_by_max,ylimits)
...
title_str='tuning of neg signif inter fields';
plot2dmats(pos_ax_mat,pos_ax_tuning, data, dis_per_field_bin_vec_of_center,title_str,sort_by_max,ylimits)
...
title_str='tuning of compound inter fields';
plot2dmats(pos_ax_mat,pos_ax_tuning, data, dis_per_field_bin_vec_of_center,title_str,sort_by_max,ylimits)
...
title_str='zscore tuning of all valid inter fields';
plot2dmats(pos_ax_mat,pos_ax_tuning, data, dis_per_field_bin_vec_of_center,title_str,sort_by_max,ylimits)
...
title_str='zscore tuning of signif inter fields';
plot2dmats(pos_ax_mat,pos_ax_tuning, data, dis_per_field_bin_vec_of_center,title_str,sort_by_max,ylimits)
...
title_str='zscore tuning of pos signif inter fields';
plot2dmats(pos_ax_mat,pos_ax_tuning, data, dis_per_field_bin_vec_of_center,title_str,sort_by_max,ylimits)
...
title_str='zscore tuning of neg signif inter fields';
plot2dmats(pos_ax_mat,pos_ax_tuning, data, dis_per_field_bin_vec_of_center,title_str,sort_by_max,ylimits)
...
title_str='zscore tuning of compound inter fields';
plot2dmats(pos_ax_mat,pos_ax_tuning, data, dis_per_field_bin_vec_of_center,title_str,sort_by_max,ylimits)


%% save
fig_file_name=['D:\Ayelet\2bat_proj\Analysis\new_code\figures\population\inter_field_zscore_color_bar_sort_by_',num2str(sort_by_max),'.jpg'];
