...
clear
clc
cells_num_dir=[215 1;215 2;282 1;261 2;277 1;277 2;272 1;283 1];
...
for ii_cell = 1:length(cells_num_dir)
    raster_ax{ii_cell} = axes('units','normalized','Position',[x_rater(ii_cell) y_raster(ii_cell) 0.17 0.06]); % allo fr comparison
    psth_ax{ii_cell} = axes('units','normalized','Position',[x_psth(ii_cell) y_psth(ii_cell) 0.17 0.06]); % allo fr comparison
end
...
fig_name=fullfile(dir_name,'place_cells');
