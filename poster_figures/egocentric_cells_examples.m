...
clear
clc
cells_num_dir=[235 2;251 2;298 2;284 2;292 2;290 1;245 2;253 1;241 1;274 2;282 1];
%cells_num_dir=[235 2;251 2;290 1;296 2;284 2;292 2];
...
solo_psth_ax = axes('units','normalized','Position',[x_solo_psth y_pos 0.05 0.17]); % allo fr comparison
    ...
    if exist(file_name)
        ...
        text(0.43,0.8, 'Solo data','fontsize',fsize,'fontweight','bold')
        text(0.15,0.8,'Cross-over data','fontsize',fsize,'fontweight','bold')
        box off
        axis off
        %% 2D raster CO
        axes(co_raste_ax)
